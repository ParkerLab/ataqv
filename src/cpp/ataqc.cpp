...
void print_usage() {
    ...
    std::cout << "ataqc " << version_string() << ": QC metrics for ATAC-seq data" << std::endl << std::endl

              << "Usage:" << std::endl << std::endl << "ataqc [options] organism alignment-file" << std::endl << std::endl
              << "where:" << std::endl
              ...
              << "    the BAM file, with the suffix \".ataqc.json\"." << std::endl << std::endl
              ...
              << "ataqc includes lists of autosomes for several organisms:" << std::endl << std::endl
